...
describe('PlayerComponent', () => {
  ...
  fit('Week4_Day5_create_Player_component', () => {
    expect(component).toBeTruthy();
  });

  fit('Week4_Day5_should have edit buttons for each player', () => {
  ...
  fit('Week4_Day5_should have delete buttons for each player', () => {
    const player = { id: 1, name: 'Test Player', age: 25, category: 'Category A', biddingPrice: 100 };
